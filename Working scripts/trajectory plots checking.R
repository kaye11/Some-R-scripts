...
qplot(X, Y, data=k, color = factor(A), group = factor(A))+ geom_point(size=4)+
  geom_path(lineend="round", size=2, arrow=arrow(angle=45, ends="both", type= "closed", length=unit (0.3, "inches")), 
